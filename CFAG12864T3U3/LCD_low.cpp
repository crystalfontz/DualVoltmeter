...
const uint8_t Static_Indicator_Columns[16] PROGMEM =
  {0x03, //SI_LEAF          0x8000
   0x0A, //SI_DOC           0x4000
   0x14, //SI_BATTERY       0x2000
   0x11, //SI_BATT_BAR_0    0x1000
   0x12, //SI_BATT_BAR_1    0x0800
   0x13, //SI_BATT_BAR_2    0x0400
   0x20, //SI_COMPUTER      0x0200
   0x2F, //SI_ANTENNA       0x0100
   0x3A, //SI_SPEAKER       0x0080
   0x3D, //SI_SPEAKER_MUTE  0x0040
   0x46, //SI_PHONE         0x0020
   0x50, //SI_MAIL          0x0010
   0x5B, //SI_BELL          0x0008
   0x66, //SI_CLOCK         0x0004
   0x71, //SI_WARNING       0x0002
   0x7B};//SI_SYNC          0x0001
//----------------------------------------------------------------------------
